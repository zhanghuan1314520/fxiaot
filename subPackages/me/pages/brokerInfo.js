require("../common/vendor.js"), (global.webpackJsonp = global.webpackJsonp || []).push([ [ "subPackages/me/pages/brokerInfo" ], {
    "0216": function(t, e, n) {},
    "2ec1": function(t, e, n) {
        "use strict";
        n.r(e);
        var a = n("efb8"), s = n("c8cc");
    ...
    a9c2: function(t, e, n) {
        ...
        (function(t) {
            ...
            n("6cdc"), e(n("66fd")), t(e(n("2ec1")).default);
        ...
        (function(t) {
            ...
            var h = n("f4fd"), f = {
                ...
                onShareAppMessage: function() {
                    var t = "/subPackages/me/pages/salesMan?inviter_id=".concat(this.salesMan_id);
                    return i.share.share(this.shareTitle, t);
                },
                        ...
                        return a.default.wrap(function(t) {
                            for (;;) switch (t.prev = t.next) {
                              ...
                              case 6:
                                ...
                                }), !this.project_id && r && r.data.length > 0 && (this.project_id = r.data[0].project_id), 
                                t.next = 12, this.reload.call(this);
                ...
                methods: {
                    ...
                    toUrl: function() {
                        t.navigateTo({
                            url: "/subPackages/me/pages/personInfo?id=".concat(this.salesMan_id)
                        });
                    },
                    changeShareTitle: function(t) {
                        t && t.detail && s.default.sendFromID(t.detail.formId).then(function() {}), this.shareTitle = "这里有很多用户，快来和我一起入驻吧！";
                    },
                            ...
                            return a.default.wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                  ...
                                  case 3:
                                    ...
                                    this.content = this.content.map(function(t) {
                    ...
                    drawImage: function() {
                        var e = u(a.default.mark(function e() {
                            var n, r, c, l, u, h, f, d, p, v, g, m, w, b, y, _, S, j, x, F = this;
                            return a.default.wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                  case 0:
                                  ...
                                  case 12:
                                    d = e.sent, p = o(d, 6), v = p[0], g = p[1], m = p[2], w = p[3], b = p[4], y = p[5], 
                                    v && g && m && w && b && y && (_ = {
                                        3: m,
                                        2: w,
                                        1: b
                                    ...
                                    S.setFontSize(24 * l), S.setFillStyle("#666"), S.fillText("经纪人", 240 * l, j), f(S, "杭州房小团", this.canvasWidth), 
                                    ...
                                    x = (this.canvasWidth - 300 * l) / 2, j += 97 * l, S.drawImage(y, x, j, 300 * l, 300 * l), 
...
}, [ [ "a9c2", "common/runtime", "common/vendor" ] ] ]);